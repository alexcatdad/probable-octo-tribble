...
export const FindingsRail = memo(function FindingsRail({
  className,
  document,
  findings,
  selectedFindingId,
  ...
  const clauseLabels = useMemo(() => buildClauseLabels(document), [document]);
  ...
  return (
    ...
    >
      <section className="glass-tile-strong rounded-2xl px-[var(--tile-inset)] py-5">
        ...
        <div className="auto-contain-children soft-scroll space-y-3 min-[1180px]:max-h-[calc(100vh-17rem)] min-[1180px]:overflow-y-auto min-[1180px]:pr-1">
