  ...
  return (
    ...
    >
      <section className="col-span-12 grid gap-5 lg:grid-cols-12">
        <div className="col-span-12 rounded-[2rem] border border-[var(--glass-border)] bg-[linear-gradient(180deg,rgba(255,255,255,0.82),rgba(247,242,235,0.72))] px-[var(--tile-inset)] py-8 shadow-[0_30px_120px_-50px_rgba(58,39,17,0.18)] lg:col-span-7 lg:py-10">
          <div className="flex flex-wrap items-center gap-3">
            <span className="rounded-full border border-[var(--glass-border)] bg-[rgba(255,255,255,0.62)] px-3 py-1 text-[0.68rem] font-semibold uppercase tracking-[0.24em] text-[var(--muted-foreground)]">
              Legal workflow demo
            </span>
        ...
        <aside className="col-span-12 overflow-hidden rounded-[2rem] border border-[var(--glass-border)] bg-[rgba(255,255,255,0.72)] px-[var(--tile-inset)] py-7 shadow-[0_24px_80px_-46px_rgba(58,39,17,0.16)] lg:col-span-5 lg:py-8">
          <div className="flex items-center justify-between gap-3">
            <div>
              <p className="text-[0.68rem] font-semibold uppercase tracking-[0.24em] text-[var(--muted-foreground)]">
                Sample matter
              </p>
              <h2 className="document-type mt-3 text-[2rem] leading-none tracking-[-0.05em] text-[var(--foreground)]">
                Acme Co. v. OmniCore
              </h2>
            </div>
            <div className="rounded-full border border-[var(--tone-warning-border)] bg-[var(--tone-warning)] px-3 py-1 text-[0.68rem] font-semibold uppercase tracking-[0.18em] text-[var(--tone-warning-text)]">
              Review
            </div>
          </div>
          ...
          <dl className="mt-6 grid gap-3 sm:grid-cols-3 lg:grid-cols-1">
            {matterHighlights.map((item) => (
              <div
                key={item.label}
                className="rounded-2xl border border-[var(--glass-border)] bg-[rgba(255,255,255,0.6)] px-4 py-4"
              >
                <dt className="text-[0.68rem] font-semibold uppercase tracking-[0.2em] text-[var(--muted-foreground)]">
                  {item.label}
                </dt>
                <dd className="mt-2 text-base font-semibold text-[var(--foreground)]">
                  {item.value}
                </dd>
              </div>
            ))}
          ...
          <div className="mt-6 rounded-[1.6rem] border border-[var(--glass-border)] bg-[linear-gradient(180deg,rgba(255,255,255,0.78),rgba(247,242,235,0.72))] p-5">
            <div className="flex items-center justify-between gap-3">
              <div>
              ...
              <div className="rounded-full border border-[var(--glass-border)] bg-[rgba(255,255,255,0.6)] px-3 py-1 text-[0.68rem] font-semibold uppercase tracking-[0.18em] text-[var(--muted-foreground)]">
                Awaiting review
              </div>
            </div>
      ...
      <section className="col-span-12 grid gap-5 lg:grid-cols-12">
        <div className="col-span-12 rounded-[2rem] border border-[var(--glass-border)] bg-[rgba(255,255,255,0.74)] px-[var(--tile-inset)] py-7 lg:col-span-4">
          <p className="text-[0.68rem] font-semibold uppercase tracking-[0.22em] text-[var(--muted-foreground)]">
            Why it reads differently
          </p>
          <h2 className="document-type mt-4 text-[2rem] leading-none tracking-[-0.05em] text-[var(--foreground)]">
        ...
        {proofPoints.map((point) => (
          <article
            key={point.title}
            className="col-span-12 rounded-[2rem] border border-[var(--glass-border)] bg-[rgba(255,255,255,0.72)] px-[var(--tile-inset)] py-7 lg:col-span-4"
          >
            <p className="text-[0.68rem] font-semibold uppercase tracking-[0.2em] text-[var(--muted-foreground)]">
              Product principle
            </p>
            <h3 className="mt-4 text-[1.2rem] font-semibold tracking-[-0.03em] text-[var(--foreground)]">
              {point.title}
            </h3>
      ...
      <section className="col-span-12 rounded-[2rem] border border-[var(--glass-border)] bg-[linear-gradient(180deg,rgba(255,255,255,0.76),rgba(247,242,235,0.72))] px-[var(--tile-inset)] py-7">
        <div className="max-w-2xl">
          <p className="text-[0.68rem] font-semibold uppercase tracking-[0.22em] text-[var(--muted-foreground)]">
            End-to-end flow
          </p>
          <h2 className="document-type mt-4 text-[2.35rem] leading-none tracking-[-0.05em] text-[var(--foreground)]">
        ...
        <div className="mt-8 grid gap-4 lg:grid-cols-3">
          {workflowSteps.map((step, index) => {
            ...
            return (
              <article
                key={step.label}
                className="rounded-[1.7rem] border border-[var(--glass-border)] bg-[rgba(255,255,255,0.72)] px-5 py-5"
              >
